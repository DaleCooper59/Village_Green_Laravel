...
class insertDatas extends Command
{
    ...
    public function handle()
    {
         ...
         */
        $labels = [
            'Guitarre électrique Strat Sterling', 'Guitarre électrique Ltd mh200', 'Guitarre électrique sterling jason richardson natural poplar', 'Batterie pearl decade maple jazz 18inch', 'Batterie debut kit',
