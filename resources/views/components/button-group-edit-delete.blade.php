  ...
  <div {{$attributes->merge(['class' => "flex top-2"])}}>
    ...
    <form {{$route}} method="post">
        ...
        @method('delete')
        <button type="submit"
            class="h-8 font-semibold py-1 px-4 mr-1 rounded shadow cursor-pointer inline-block m-0 mb-1 bg-red_custom hover:bg-red_custom-dark text-gray-800">{{$action2}}</button>
